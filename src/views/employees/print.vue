    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="printObj" size="mini" type="primary" style="margin-top: 10px">打印</el-button>
        </el-row>
...
<script>
import { getUserJob, getUserBaseInfo } from '@/api/employees'
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = await getUserDetailById(this.userId) // 获取个人基本信息
    },
    async getJobDetail() {
